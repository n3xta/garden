...
function initAuthPage() {
  const fromAuthPage = document.referrer.includes('/login.html') || document.referrer.includes('/register.html');
...
function handleAuthTransition(event, formType) {
  ...
  woodImage.onload = () => {
    ...
    setTimeout(() => {
      window.location.href = formType === 'login' ? '/login.html' : '/register.html';
    }, 1200);
  };
